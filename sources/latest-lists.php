...
foreach ($latest_news as $key => $fl['top_news_data']) {
    $fl['top_news_data']['news']['page_type'] = 'lists';
...
$fl['content'] = FL_LoadPage('latest/lists', array('TOP_4' => $top_news_html, 'TOP_BIG' => $big_top_news_html));
$fl['page_url']            = $fl['config']['site_url'].'/latest-lists'.$text;
?>