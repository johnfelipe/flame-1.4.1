...
$text = '';
if (isset($_GET['user']) && !empty($_GET['user']) && ($fl['is_admin'] === true || FL_IsModerator())) {
...
if (!empty($_SESSION['refilled_balance'])) {
	$fl['refilled_balance'] = $_SESSION['refilled_balance'];
...
$fl['page_url']            = $fl['config']['site_url'].'/settings/'.$fl['setting_page'].$text;