...
$fl['title'] = $lang['saved_drafts'] . ' | ' . $fl['config']['title'];
$fl['description'] = $fl['config']['description'];
$fl['page'] = 'saved-drafts';
...
$fl['content'] = FL_LoadPage('saved-drafts/content', array(
...
$fl['page_url']            = $fl['config']['site_url'].'/saved-drafts';