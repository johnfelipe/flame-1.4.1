...
foreach ($search_results as $key => $search_results_) {
	foreach ($search_results_ as $key_ => $results) {
		$fl['latest_news_data'] = $results;
		if ($key == 'news') {
			$fl['latest_news_data']['page_type'] = 'news';
		...
		if ($key == 'lists') {
			$fl['latest_news_data']['page_type'] = 'lists';
		...
		if ($key == 'videos') {
			$fl['latest_news_data']['page_type'] = 'videos';
		...
		if ($key == 'music') {
			$fl['latest_news_data']['page_type'] = 'music';
		...
		if ($key == 'polls') {
			$fl['latest_news_data']['page_type'] = 'polls';
		...
		if ($key == 'quiz') {
			$fl['latest_news_data']['page_type'] = 'quiz';
