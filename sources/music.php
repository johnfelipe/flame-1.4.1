...
foreach (FL_GetPostTags($fl['music']['tags']) as $key => $tag) {
    $tags .= '<a class="tags music" href="{{LINK tags/' . $tag . '}}" data-ajax="?link1=tags&tag='.$tag.'">' . $tag . '</a> ';
}
...
$page_context  =  array(
    ...
    'STORY_AJAX_LINK' => '?link1=music&id='.$fl['music']['slug'].'-'.$fl['music']['id'],
    'STORY_CATEGORY_LINK' => '?link1=latest-music&c_id='.$fl['music']['category'],
    'STORY_USER_LINK' => '?link1=profile&u='.$fl['music']['publisher']['username'],
...
$fl['page_url']            = $fl['config']['site_url'].'/music/'.$_GET['id'];
